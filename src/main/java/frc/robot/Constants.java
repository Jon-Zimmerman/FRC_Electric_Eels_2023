...
public final class Constants {
    ...
    public static final class ElevatorSubsystem {
        ...
        public static final double elevatorPosLoading = 25.0;
        public static final double elevatorPosTop = 30.0;
    ...
    public static final class SliderSubsystem {
        ...
        public static final double sliderSoftLimitUpperInch = 22.0;
