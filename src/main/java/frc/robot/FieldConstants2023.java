 ...
 */
public final class FieldConstants2023 {
  ...
  public static final class Community {
    ...
    public static final double midX = Units.inchesToMeters(132.375); // Tape to the left of charging
                                                                     // station
    ...
    public static final double midY =
        leftY - Units.inchesToMeters(59.39) + tapeWidth;
    ...
    public static final double chargingStationLength =
        Units.inchesToMeters(76.125);
    public static final double chargingStationWidth =
        Units.inchesToMeters(97.25);
  ...
  public static final class Grids {
    ...
    public static final double highCubeZ =
        Units.inchesToMeters(35.5) - cubeEdgeHigh;
    public static final double midCubeZ =
        Units.inchesToMeters(23.5) - cubeEdgeHigh;
    ...
    static {
      for (int i = 0; i < nodeRowCount; i++) {
        ...
        lowTranslations[i] =
            new Translation2d(lowX, nodeFirstY + nodeSeparationY * i);
        midTranslations[i] =
            new Translation2d(midX, nodeFirstY + nodeSeparationY * i);
        mid3dTranslations[i] = new Translation3d(midX,
            nodeFirstY + nodeSeparationY * i, isCube ? midCubeZ : midConeZ);
        high3dTranslations[i] = new Translation3d(highX,
            nodeFirstY + nodeSeparationY * i, isCube ? highCubeZ : highConeZ);
        highTranslations[i] =
            new Translation2d(highX, nodeFirstY + nodeSeparationY * i);
      }
    }
  ...
  public static final class StagingLocations {
    ...
    static {
      for (int i = 0; i < translations.length; i++) {
        translations[i] =
            new Translation2d(positionX, firstY + (i * separationY));
      }
    }
  }
  ...
  public static final Map<Integer, Pose3d> aprilTags =
      Map.of(1,
          ...
          new Pose3d(Units.inchesToMeters(610.77), Units.inchesToMeters(108.19),
              Units.inchesToMeters(18.22), new Rotation3d(0.0, 0.0, Math.PI)),
          3,
          new Pose3d(Units.inchesToMeters(610.77), Units.inchesToMeters(174.19), // FIRST's diagram
                                                                                 // has a typo (it
                                                                                 // says 147.19)
              Units.inchesToMeters(18.22), new Rotation3d(0.0, 0.0, Math.PI)),
          4,
          ...
          6,
          new Pose3d(Units.inchesToMeters(40.45), Units.inchesToMeters(174.19), // FIRST's diagram
                                                                                // has a typo (it
                                                                                // says 147.19)
