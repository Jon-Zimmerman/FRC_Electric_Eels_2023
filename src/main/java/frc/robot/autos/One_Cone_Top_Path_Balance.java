...
public class One_Cone_Top_Path_Balance extends SequentialCommandGroup {
    List<PathPlannerTrajectory> pathGroup = PathPlanner.loadPathGroup("Top_Path", new PathConstraints(Constants.AutoConstants.kMaxSpeedMetersPerSecond, Constants.AutoConstants.kMaxAccelerationMetersPerSecondSquared));
    //final HashMap<String, Command> eventMap = new HashMap<String, Command>();
    final Command followTopPath;
    public One_Cone_Top_Path_Balance(Swerve s_Swerve, Intake intake, Elevator elevator,Slider slider){
        ...
        followTopPath = s_Swerve.swerveAutoBuilder.fullAuto (pathGroup);
