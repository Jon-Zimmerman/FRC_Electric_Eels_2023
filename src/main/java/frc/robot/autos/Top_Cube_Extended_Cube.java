...
public class Top_Cube_Extended_Cube extends SequentialCommandGroup {
    List<PathPlannerTrajectory> Path01= PathPlanner.loadPathGroup("Top_Extended_01", new PathConstraints(Constants.AutoConstants.kMaxSpeedMetersPerSecond, Constants.AutoConstants.kMaxAccelerationMetersPerSecondSquared));
    List<PathPlannerTrajectory> Path02= PathPlanner.loadPathGroup("Top_Extended_02", new PathConstraints(Constants.AutoConstants.kMaxSpeedMetersPerSecond, Constants.AutoConstants.kMaxAccelerationMetersPerSecondSquared));
    List<PathPlannerTrajectory> Path03= PathPlanner.loadPathGroup("Top_Extended_03", new PathConstraints(Constants.AutoConstants.kMaxSpeedMetersPerSecond, Constants.AutoConstants.kMaxAccelerationMetersPerSecondSquared));
    ...
    public Top_Cube_Extended_Cube(Swerve s_Swerve, Intake intake, Elevator elevator,Slider slider){
